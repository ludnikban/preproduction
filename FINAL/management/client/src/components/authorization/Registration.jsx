...
const Registration = () => {
  ...
  return (
    <div className='authorization'>
      ...
      <Input value={phone_Number} setValue={setphone_Number} type="text" placeholder="Введите номер телефона..." required/>
      ...
      <button className="authorization__btn" onClick={() =>
        dispatch(registration(last_Name, first_Name, nick_Name, email, password, phone_Number, description, position))}>Зарегистрироваться</button>
    </div>
  )
}
